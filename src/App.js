...
const logos = [
  { id: 1, name: "Nova Tech", image: "https://images.unsplash.com/photo-1611262588024-d12430b98920?q=80&w=400&auto=format&fit=crop", description: "Tech startup specializing in AI solutions" },
  { id: 2, name: "EcoLeaf", image: "https://images.unsplash.com/photo-1634942536743-c3cc349bae2a?q=80&w=400&auto=format&fit=crop", description: "Sustainable products company" },
  { id: 3, name: "Apex Fitness", image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=400&auto=format&fit=crop", description: "Premium fitness center chain" },
  { id: 4, name: "Culinary Craft", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=400&auto=format&fit=crop", description: "Artisan food brand" },
  { id: 5, name: "Zenith Studios", image: "https://images.unsplash.com/photo-1601152888642-f2f1ac6d3f6b?q=80&w=400&auto=format&fit=crop", description: "Creative agency focusing on photography" },
  { id: 6, name: "Urban Threads", image: "https://images.unsplash.com/photo-1566206091558-7f218b696731?q=80&w=400&auto=format&fit=crop", description: "Streetwear clothing brand" },
  { id: 7, name: "Solaris Energy", image: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?q=80&w=400&auto=format&fit=crop", description: "Renewable energy company" },
  { id: 8, name: "Harbor Coffee", image: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=400&auto=format&fit=crop", description: "Specialty coffee roasters" },
  { id: 9, name: "Pivot Consulting", image: "https://images.unsplash.com/photo-1560472355-536de3962603?q=80&w=400&auto=format&fit=crop", description: "Business strategy consultants" },
  { id: 10, name: "Terra Firma", image: "https://images.unsplash.com/photo-1520034475321-cbe63696469a?q=80&w=400&auto=format&fit=crop", description: "Outdoor adventure company" },
  { id: 11, name: "Nexus Labs", image: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?q=80&w=400&auto=format&fit=crop", description: "Innovative tech research lab" },
  { id: 12, name: "Bliss Yoga", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&auto=format&fit=crop", description: "Wellness and yoga studio" },
  { id: 13, name: "Crimson Publishing", image: "https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=400&auto=format&fit=crop", description: "Independent book publisher" },
  { id: 14, name: "Momentum Motors", image: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?q=80&w=400&auto=format&fit=crop", description: "Electric vehicle manufacturer" },
  { id: 15, name: "Aura Beauty", image: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?q=80&w=400&auto=format&fit=crop", description: "Organic skincare brand" },
  { id: 16, name: "Verde Restaurant", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=400&auto=format&fit=crop", description: "Plant-based fine dining" },
  { id: 17, name: "Summit Ventures", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=400&auto=format&fit=crop", description: "Venture capital firm" },
  { id: 18, name: "Flow State", image: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=400&auto=format&fit=crop", description: "Productivity app for creators" },
  { id: 19, name: "Nimbus Weather", image: "https://images.unsplash.com/photo-1589652717521-10c0d092dea9?q=80&w=400&auto=format&fit=crop", description: "Weather forecasting service" },
  { id: 20, name: "Echo Records", image: "https://images.unsplash.com/photo-1494232410401-ad00d5433cfa?q=80&w=400&auto=format&fit=crop", description: "Independent music label" },
];
...
const testimonials = [
  {
    name: "John Harris",
    role: "Marketing Director",
    quote: "Created a timeless logo that perfectly captures our brand essence and values.",
    avatar: "https://i.pravatar.cc/100?img=13",
  },
  {
    name: "Sarah Johnson",
    role: "CEO",
    quote: "The logo design process was collaborative and resulted in a mark we absolutely love.",
    avatar: "https://i.pravatar.cc/100?img=5",
  },
  {
    name: "Michael Lee",
    role: "Product Manager",
    quote: "Our new logo has significantly improved brand recognition and customer engagement.",
    avatar: "https://i.pravatar.cc/100?img=26",
  },
  {
    name: "Laura Bennett",
    role: "Founder",
    quote: "The attention to detail in our logo and brand system was exceptional.",
    avatar: "https://i.pravatar.cc/100?img=8",
  },
];
...
const faqs = [
  {
    q: "What's included in a logo design package?",
    a: "I deliver multiple concepts, revisions, final files in all formats, and a brand style guide.",
  },
  {
    q: "How long does logo design take?",
    a: "Typically 2-3 weeks from initial consultation to final delivery, depending on complexity.",
  },
  {
    q: "Do you provide vector files?",
    a: "Yes, you'll receive AI, EPS, PDF, SVG, and PNG files in various sizes.",
  },
  {
    q: "What industries do you specialize in?",
    a: "I've created logos for tech startups, restaurants, fashion brands, nonprofits, and more.",
  },
];
    ...
    <Section id="home" className="pt-36 md:pt-40">
      <div className="grid items-center gap-10 md:grid-cols-2">
        <div>
          ...
          >
            <AnimatePresence mode="wait">
              <motion.span
                key={currentText}
                className="block bg-clip-text min-h-28 text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                exit={{ y: -20, opacity: 0 }}
                transition={{ duration: 0.5 }}
        ...
        <div ref={ref} className="relative h-[480px] md:h-[560px]">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1567446537736-9cb0e7b34c64?q=80&w=400&auto=format&fit=crop"
      ...
      <div className="grid gap-10 md:grid-cols-2">
        <div>
          ...
          <motion.p 
            ...
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            Hi, I'm <span className="text-white">Duncan</span> — a dedicated logo designer with a passion for creating visual identities that resonate. I believe a great logo is the foundation of a strong brand.
          </motion.p>
          <motion.div 
            className="mt-6 grid grid-cols-2 gap-6"
            initial={{ opacity: 0 }}
            ...
            transition={{ delay: 0.4, duration: 0.6 }}
          >
            <Stat value="300+" label="Logos Designed" />
            <Stat value="8+" label="Years Experience" />
            <Stat value="98%" label="Client Satisfaction" />
            <Stat value="24" label="Design Awards" />
          </motion.div>
        </div>
        <motion.div
          initial={{ opacity: 0, x: 20 }}
...
function LogoCarousel({ direction = "right", speed = 40 }) {
    ...
    <div className="relative w-full overflow-hidden py-8">
      ...
      >
        {duplicatedLogos.map((logo, index) => (
          <div
            key={`${logo.id}-${index}`}
            className="group relative mx-4 flex h-40 w-40 shrink-0 items-center justify-center rounded-2xl bg-white/5 p-6 backdrop-blur-md transition-all duration-300 hover:bg-white/10 interactive"
          >
            <img
              src={logo.image}
              alt={logo.name}
